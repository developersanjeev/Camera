...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            $model = $this->_objectManager->create('Camera\Feed\Model\Camerafeed');
            ...
            try {
                $model->save();
                $this->messageManager->addSuccess(__('The Camerafeed has been saved.'));
                ...
                $this->messageManager->addException($e, __('Something went wrong while saving the Camerafeed.'));
            }
